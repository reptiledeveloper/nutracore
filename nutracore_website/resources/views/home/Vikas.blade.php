        ...
        <div class="container">
            ...
            <div style="position: relative;">
                <div style="height: 466px;" >
                    <img src="{{url('public/assets/images/Vikas.png')}}" style="width: 100%; height: 100%;" " />
                </div>

                <!-- Hero Section -->
                <div class="hero-section" style="position: absolute;top: 0; left: 0; width: 100%;">
                    <div class="content">
                        <h2 class="fw-bold" style="font-size: 54px; color: white; margin-bottom: 11px;">Its Time To Gain More<br> Muscles</h2>
                        <p class="mb-4 fw-bold" style="font-size: 27px; color: white; margin-bottom: 17px;">BODY PERFORMANCE</p>
                        <button class="join-btn" style="width: 422px; height: 67px; border-radius: 8px;">JOIN NOW</button>
                    </div>
                </div>
            ...
            <!-- Benefits Row -->
            <div class="row g-3 features-row" style="padding-left: 40px; padding-right: 40px;">
