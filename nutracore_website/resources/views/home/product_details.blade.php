                                ...
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <div class="detail-extralink mb-50">
                                        <div class="detail-qty border radius">
                                            ...
                                            <input type="text" name="quantity" id="quantity" class="qty-val"
                                        ...
                                        <div class="product-extra-link2">
                                            <button class="button button-add-to-cart" onclick="addToCart()"><i
                                    ...
                                    <input type="hidden" id="selectedProductID" value="{{ $product_data->id ?? '' }}">
                                    <input type="hidden" id="selectedVarientID" value="{{ $selectedVarient->id ?? '' }}">
                                        ...
                                        <div class="col-lg-12 col-md-12 mt-3">
                                            <div class="featured-card">
                                                ...
                                                <div class="d-flex m-2">
                                                    <input type="text" name="" id="pincode"> <button class="btn"
                                                        onclick="getEstimateDelivery()">Submit</button>
                                                </div>
                                                <div class="mt-3">
                                                    <p class="d-flex" style="margin-bottom:-15px">
                                                        <img src="{{ url('public/assets/images/tick.png') }}"
                                                            style="width: 23px;">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <span style="color:#00A8A8;font-weight:600;">Free Shipping </span>
                                                        &nbsp; available on &nbsp;<span id="estimate_delivery">
                                                    ...
                                                    <p class="d-flex" style="margin-bottom:-15px">
                                                        <img src="{{ url('public/assets/images/tick.png') }}"
                                                            style="width: 23px;">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <span style="color:#00A8A8;font-weight:600;">Pay on Delivery </span>
                                                        &nbsp; might be available
                                                    </p>
                                                    <p class="d-flex" style="margin-bottom:-15px">
                                                        <img src="{{ url('public/assets/images/tick.png') }}"
                                                            style="width: 23px;">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <span style="color:#00A8A8;font-weight:600;">Easy Return </span>
                                                        &nbsp; on all Products
                                                    </p>
                                                </div>
                                    ...
                                    <div class="font-xs">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-12 mt-3">
                                                <img src="{{ url('public/assets/images/genuine.png') }}">
                                            </div>
                                            <div class="col-lg-4 col-md-12 mt-3">
                                                <img src="{{ url('public/assets/images/fast_delivery.png') }}">
                                            </div>
                                            <div class="col-lg-4 col-md-12 mt-3">
                                                <img src="{{ url('public/assets/images/secure_payment.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="font-xs">
                                        <div class="row">
                                            <img src="{{ url('public/assets/images/certificate.png') }}">
                                        </div>
                                    </div>
                                ...
                                <ul class="nav nav-tabs text-uppercase">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="Additional-info-tab" data-bs-toggle="tab"
                                            href="#Additional-info">Nutritions</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        <div class="vendor-logo d-flex mb-30">
                                            <img src="public/assets/imgs/vendor/vendor-18.svg" alt="" />
                                        ...
                                        <ul class="contact-infor mb-50">
                                            <li><img src="public/assets/imgs/theme/icons/icon-location.svg"
                                                    alt="" /><strong>Address: </strong> <span>5171 W Campbell Ave undefined
                                                    Kent, Utah 53127 United States</span></li>
                                            <li><img src="public/assets/imgs/theme/icons/icon-contact.svg"
                                ...
                                <div class="row related-products">
                                    @foreach($products as $product)
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            @include('home.single_product', ['products' => $product])
                                        </div>
                                    @endforeach
