                    ...
                    <div class="card-body">
                        <div class="d-md-flex gap-4 align-items-center">
                            ...
                            <div class="dropdown ms-auto">
                                <a href="{{ route('categories.add', ['back_url' => $BackUrl]) }}" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                    ...
                                    <div class="d-flex">
                                        <div class="dropdown ms-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="{{route('categories.edit',$cat->id.'?back_url='.$BackUrl)}}" class="dropdown-item">Edit</a>
