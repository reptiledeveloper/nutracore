                    ...
                    <div class="card-body">
                        <div class="d-md-flex gap-4 align-items-center">
                            ...
                            <div class="dropdown ms-auto">
                                <a href="{{ route('attributes.add', ['back_url' => $BackUrl]) }}" class="btn btn-primary"><i
                                    ...
                                    <div class="d-flex">
                                        <div class="dropdown ms-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="{{route('attributes.edit',$attr->id.'?back_url='.$BackUrl)}}"
                                                   class="dropdown-item">Edit</a>
                                                <a href="{{route('attributes.delete',$attr->id.'?back_url='.$BackUrl)}}"
