...
@section('content')
    ...
    $nc_partner_tire_id = $nc_partner_tire->id ?? '';
    $title = $nc_partner_tire->title ?? '';
    $type = $nc_partner_tire->type ?? '';
    $from_amount = $nc_partner_tire->from_amount ?? '';
    $to_amount = $nc_partner_tire->to_amount ?? '';
    $cashback = $nc_partner_tire->cashback ?? '';
    $additional_perk = $nc_partner_tire->additional_perk ?? '';
    $max_cashback = $nc_partner_tire->max_cashback ?? '';
    $status = $nc_partner_tire->status ?? '1';
    ?>
                ...
                <div class="card mt-3">
                    <div class="card-body pt-0">
                        <form class="card-body" action="" method="post" accept-chartset="UTF-8"
                            ...
                            {{ csrf_field() }}
                            <input type="hidden" id="id" value="{{ $nc_partner_tire_id }}">
