...
@section('content')
    ...
    $collections_id = isset($collections->id) ? $collections->id : '';
    $status = isset($collections->status) ? $collections->status : '';
    $product_ids = isset($collections->product_idss) ? $collections->product_idss : '';
                ...
                <div class="card mt-3">
                    <div class="card-body pt-0">
                        <form class="card-body" action="" method="post" accept-chartset="UTF-8"
                            ...
                            {{ csrf_field() }}
                            <input type="hidden" id="id" value="{{ $collections_id }}">

                            <div class="row">
                               
                                @include('layouts.product_search',['selected_data'=>$collections,'multiple'=>'multiple'])
