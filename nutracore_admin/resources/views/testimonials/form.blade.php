...
@section('content')
    ...
    if (!empty($image)) {
        $image = \App\Helpers\CustomHelper::getImageUrl('testimonials', $image);
    }
                ...
                <div class="card mt-3">
                    <div class="card-body pt-0">
                        <form class="card-body" action="" method="post" accept-chartset="UTF-8"
                            ...
                            {{ csrf_field() }}
                            <input type="hidden" id="id" value="{{ $testimonial_id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           name="description" value="{{ old('description', $description) }}">
