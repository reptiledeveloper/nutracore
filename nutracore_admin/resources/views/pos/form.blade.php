...
<input type="hidden" id="cashback_wallet_use" name="cashback_wallet_use" value="{{$settings->cashback_wallet_use??0}}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="input-group">
                        <input type="number" id="nc_cash_val" class="form-control" placeholder="Enter Points">
...
<script>
    ...
    function addProductRow(product) {
        console.log(product);
        console.log(product.selling_price.toFixed(2));
        rowCount++;
