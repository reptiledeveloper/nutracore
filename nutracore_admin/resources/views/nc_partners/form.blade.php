                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 mt-3">
                                    ...
                                    <select class="form-control" name="role">
                                        ...
                                        <option value="Gym Owner" {{ $role=='Gym Owner'?'selected':'' }}>Gym Owner</option>
                                        <option value="Coach" {{ $role=='Coach'?'selected':'' }}>Coach</option>
                                        <option value="Influencer" {{ $role=='Influencer'?'selected':'' }}>Influencer</option>
                                        <option value="Nutritionist" {{ $role=='Nutritionist'?'selected':'' }}>Nutritionist</option>
                                    </select>
                                ...
                                <div class="form-group col-md-4 mt-3">
                                    ...
                                    <textarea class="form-control" name="full_address" rows="2">{{ old('full_address', $full_address) }}</textarea>
                                ...
                                <div class="form-group col-md-4 mt-3">
                                    ...
                                    <textarea class="form-control" name="promotion_plan" rows="2">{{ old('promotion_plan', $promotion_plan) }}</textarea>
                                ...
                                <div class="form-group col-md-4 mt-3">
                                    ...
                                    <select class="form-control" name="contact_method">
                                        <option value="">Select</option>
                                        <option value="WhatsApp" {{ $contact_method=='WhatsApp'?'selected':'' }}>WhatsApp</option>
                                        <option value="Call" {{ $contact_method=='Call'?'selected':'' }}>Call</option>
                                        <option value="Email" {{ $contact_method=='Email'?'selected':'' }}>Email</option>
                                    </select>
