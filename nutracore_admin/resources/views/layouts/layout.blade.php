...
<audio id="notification-sound" src="https://efood-admin.6amtech.com/public/assets/admin/sound/notification.mp3" preload="auto"></audio>

<script src="https://www.gstatic.com/firebasejs/8.3.2/firebase-app.js"></script>
<script src="https://www.gstatic.com/firebasejs/8.3.2/firebase-messaging.js"></script>
<script>
    async function resisterServiceworker(){
        ...
        function playNotificationSound() {
            var audio = new Audio('https://efood-admin.6amtech.com/public/assets/admin/sound/notification.mp3');
            audio.play();
        }
    ...
    $(document).ready(function () {
        ...
        messaging.onMessage(function(payload) {
            ...
            // Custom data sent along with the notification
